...
class DataProcessor(ABC):
    ...
    def run(self) -> None:
        ...
        if "experience" in self._dataset.columns:
            cleaned_result = self.remove_col_by_name(self._dataset, ["experience", "contact_info"])
            ...
            return
        elif 'id' in self._dataset.columns:
            self.result = self.remove_col_by_name(self._dataset, ["id"])
            return
